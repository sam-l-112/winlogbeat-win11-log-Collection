...
[Quick start](https://www.elastic.co/guide/en/beats/winlogbeat/9.4/winlogbeat-installation-configuration.html) guide.

## Documentation

Visit [Elastic.co Docs](https://www.elastic.co/guide/en/beats/winlogbeat/9.4/index.html)
